...
__Record_Base__ = ["Record", "DongCao", "XiCao", ]  # 基类
__Record_DongCao_Instance__ = ["RecordDongCao_1", ]
__Record_XiCao_Instance__ = ["RecordXiCao_1", ]

__all__ = __Record_Base__ + __Record_DongCao_Instance__ + __Record_XiCao_Instance__
...
class RecordDongCao_1(DongCao):
    ...
    Altitude_Max = 1737.00
    Altitude_Min = 1736.00
...
class RecordXiCao_1(XiCao):
    ...
    Altitude_Max = 1739.00
    Altitude_Min = 1738.00